...
const SEED_RECORDS = [
  ...
  },
  {
    ...
    contact: "虹桥火车站失物招领 021-22325555",
    description: "在A12检票口附近捡到黑色双肩包，已交至火车站失物招领处。包内有电脑，请携带身份证领取。",
    status: "待认领",
    item_status: "institution",
    city: "上海市",
    district: "长宁区",
  ...
  },
  {
    ...
    contact: "电话: 139****1122",
    description: "粉色羊毛围巾，末端有小流苏，是在古镇手作店买的。可能在拍照时取下遗忘。",
    status: "待找回",
    item_status: "unknown",
    city: "上海市",
    district: "闵行区",
  ...
  },
  {
    ...
    contact: "七宝游客中心",
    description: "在老街捡到粉色围巾，末端有流苏。已交至游客中心失物招领处。",
    status: "待认领",
    item_status: "institution",
    city: "上海市",
    district: "闵行区",
...
async function handleReport(req, res) {
  ...
  try {
    ...
    await supabaseFetch(config, `/rest/v1/shiyun_reports`, {
      method: "POST",
      body: JSON.stringify({ id: `report_${Date.now()}`, record_id: recordId, reporter_id: current.sub, reason }),
    });
